  ...
  run: async (client, interaction) => {
    ...
    try {
      ...
      if (stp === 'set') {
        ...
        if (!role) {
          return interaction.reply(lang.msg26)
            .catch(e => { })
        }
        ...
        await db.musicbot.updateOne({ guildID: interaction.guild.id }, {
          ...
          .catch(e => { })
        return await interaction.reply({ content: lang.msg25.replace('{role}', role.id), ephemeral: true })
          .catch(e => { })
      ...
      if (stp === 'reset') {
        ...
        if (data?.role) {
          await db.musicbot.updateOne({ guildID: interaction.guild.id }, {
            ...
            .catch(e => { })
          return await interaction.reply({ content: lang.msg27, ephemeral: true })
            .catch(e => { })
        } else {
          return await interaction.reply({ content: lang.msg28, ephemeral: true })
            .catch(e => { })
        }
      }
