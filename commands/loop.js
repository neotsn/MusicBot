        ...
        .then(async Message => {
          ...
          col.on('collect', async (button) => {
            ...
            if (!queue1 || !queue1.playing) {
              await interaction?.editReply({ content: lang.msg5, ephemeral: true })
                .catch(e => { })
            ...
            switch (button.customId) {
              case 'queue':
                ...
                interaction?.editReply({ content: `${lang.msg40} ✅` })
                  .catch(e => { })
                await button?.deferUpdate()
                  .catch(e => {})
                break
              case 'nowplaying':
                ...
                interaction?.editReply({ content: `${lang.msg42} ✅` })
                  .catch(e => { })
                await button?.deferUpdate()
                  .catch(e => {})
                break
              case 'close':
                if (queue.repeatMode === 0) {
                  await button?.deferUpdate()
                    .catch(e => {})
                  return interaction?.editReply({ content: lang.msg43, ephemeral: true })
                    .catch(e => { })
                }
                const success4 = queue.setRepeatMode(0)
                interaction?.editReply({ content: lang.msg44 })
                  .catch(e => { })
                await button?.deferUpdate()
                  .catch(e => {})
                break
