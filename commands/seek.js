...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    try {
      ...
      if (isNaN(position)) {
        return interaction.reply({ content: `${lang.msg134}`, ephemeral: true })
          .catch(e => { })
      }

      queue.seek(position)
      interaction.reply({ content: `${lang.msg135.replace('{queue.formattedCurrentTime}', queue.formattedCurrentTime)}` })
        .catch(e => { })
